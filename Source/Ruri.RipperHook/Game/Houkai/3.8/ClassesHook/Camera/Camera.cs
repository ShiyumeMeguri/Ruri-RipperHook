...
public partial class Houkai_3_8_Hook
{
	...
	public void Camera_2017_3_0_ReadRelease(ref EndianSpanReader reader)
	{
		...
		bool HalfResolutionParticleEnable = reader.ReadBoolean();
		bool OutputHalfResolutionDepth = reader.ReadBoolean();
		bool MRTOutputDepthNormal = reader.ReadBoolean();
		bool UseDepthNormalFromUser = reader.ReadBoolean();
	}
}
