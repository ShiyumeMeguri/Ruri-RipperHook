...
{
    [RetargetMethod(typeof(EmissionModule_2017_3))]
    public void EmissionModule_2017_3_ReadRelease(ref EndianSpanReader reader)
    {
        var _this = (object)this as EmissionModule_2017_3;
        var type = typeof(EmissionModule_2017_3);
        ...
        SetAssetListField<ParticleSystemEmissionBurst_2017_3>(type, "m_Bursts", ref reader);
