...
public partial class Houkai_7_1_Hook
{
    ...
    public void Camera_2017_3_ReadRelease(ref EndianSpanReader reader)
    {
        ...
        var m_HalfResolutionParticleEnable = reader.ReadBoolean();
        var m_OutputHalfResolutionDepth = reader.ReadBoolean();
        var m_ForceLoadDepthInMotionVector = reader.ReadBoolean();
        var m_MRTOutputDepthNormal = reader.ReadBoolean();
        var m_UseDepthNormalFromUser = reader.ReadBoolean();
        var m_UsedForTextureStreaming = reader.ReadBoolean();
        var m_CullStatsCheckEnable = reader.ReadBoolean();
        var m_EnableRenderQuery = reader.ReadRelease_BooleanAlign();
    }
}