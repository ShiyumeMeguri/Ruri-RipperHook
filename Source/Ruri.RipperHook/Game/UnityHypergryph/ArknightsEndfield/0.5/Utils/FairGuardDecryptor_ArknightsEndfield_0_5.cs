...
public record class FairGuardDecryptor_ArknightsEndfield_0_5 : FairGuardDecryptor
{
    public override Span<byte> Decrypt(Span<byte> dataSpan)
    {
        ...
        var encryptedSize = Math.Min(0x500, dataSpan.Length);
        ...
        var encrypted = dataSpan.Slice(encryptedOffset, encryptedSize);
