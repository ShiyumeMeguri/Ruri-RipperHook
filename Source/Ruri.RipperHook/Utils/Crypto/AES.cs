...
{
    private static readonly byte[] ShiftRowsTableInv = { 0x00, 0x0D, 0x0A, 0x07, 0x04, 0x01, 0x0E, 0x0B, 0x08, 0x05, 0x02, 0x0F, 0x0C, 0x09, 0x06, 0x03 };
    ...
    private static void SubBytesInv(byte[] a)
    {
    ...
    private static void MixColInv(byte[] state, int off)
    {
        var a0 = state[off + 0];
        var a1 = state[off + 1];
        var a2 = state[off + 2];
