...
public static class ReadReleaseMethods
{
    ...
    public static void ReadRelease_Array_SByte(this AssetList<sbyte> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadSByte());
    }
    ...
    public static void ReadRelease_Array_Single(this AssetList<float> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadSingle());
    }
    ...
    public static void ReadRelease_Array_UInt16(this AssetList<ushort> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadUInt16());
    }
    ...
    public static void ReadRelease_Array_UInt32(this AssetList<uint> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadUInt32());
    }
    ...
    public static void ReadRelease_ArrayAlign_ArrayAlign_SerializedPlayerSubProgram(this AssetList<AssetList<SerializedPlayerSubProgram>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_ArrayAlign_Asset(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_ArrayAlign_UInt32(this AssetList<AssetList<uint>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_ArrayAlign_UInt32(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Boolean(this AssetList<bool> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadBoolean());
        reader.Align();
    }
    ...
    {
        var num = reader.ReadInt32();
        var array = ReadByteArray(ref reader, num);
        reader.Align();
        return array;
    }
    ...
    public static void ReadRelease_ArrayAlign_Int16(this AssetList<short> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadInt16());
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Int64(this AssetList<long> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.Add(reader.ReadInt64());
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Pair_Pair_Int32_Int64_Utf8StringAlign(this AssetList<AssetPair<AssetPair<int, long>, Utf8String>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Pair_Int32_Int64_Utf8StringAlign(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Pair_Utf8StringAlign_Boolean(this AssetList<AssetPair<Utf8String, bool>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Utf8StringAlign_Boolean(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Pair_Utf8StringAlign_PPtr_Texture_3_5_0(this AssetList<AssetPair<Utf8String, PPtr_Texture_3_5_0>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Utf8StringAlign_PPtr_Texture_3_5_0(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_ArrayAlign_Pair_Utf8StringAlign_UInt32(this AssetList<AssetPair<Utf8String, uint>> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Utf8StringAlign_UInt32(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_Map_Int32_Hash128(this AssetDictionary<int, Hash128> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Int32_Hash128(ref reader);
    }
    ...
    public static void ReadRelease_Map_Int32_SampleSettings_5_0_0(this AssetDictionary<int, SampleSettings_5_0_0> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Int32_SampleSettings_5_0_0(ref reader);
    }
    ...
    public static void ReadRelease_MapAlign_Utf8StringAlign_NonAlignedStruct(this AssetDictionary<Utf8String, NonAlignedStruct> value, ref EndianSpanReader reader)
    {
        value.Clear();
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++) value.AddNew().ReadRelease_Pair_Utf8StringAlign_NonAlignedStruct(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_MapAlign_Utf8StringAlign_SecondaryTextureSettings_2020_2_0(this AssetDictionary<Utf8String, SecondaryTextureSettings_2020_2_0> value, ref EndianSpanReader reader)
    {
        ...
        var num = reader.ReadInt32();
        for (var i = 0; i < num; i++)
            value.AddNew().ReadRelease_Pair_Utf8StringAlign_SecondaryTextureSettings_2020_2_0(ref reader);
        reader.Align();
    }
    ...
    public static void ReadRelease_Pair_Hash128_Int32(this AssetPair<Hash128, int> value, ref EndianSpanReader reader)
    {
        value.Key.ReadRelease(ref reader);
        value.Value = reader.ReadInt32();
    }
    ...
    public static void ReadRelease_Pair_Int32_Hash128(this AssetPair<int, Hash128> value, ref EndianSpanReader reader)
    {
        value.Key = reader.ReadInt32();
        value.Value.ReadRelease(ref reader);
    }
    ...
    {
        var utf8String = reader.ReadUtf8String();
        reader.Align();
        return utf8String;
    }
