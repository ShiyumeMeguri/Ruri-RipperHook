...
namespace HLSLccWrapper {
	WrappedShader^ WrappedShader::TranslateFromFile(String^ filepath, WrappedGLLang lang, WrappedGlExtensions^ extensions) {
		WrappedShader^ shader = gcnew WrappedShader();
	...
	WrappedShader^ WrappedShader::TranslateFromMem(array<unsigned char>^ data, WrappedGLLang lang, WrappedGlExtensions^ extensions) {
		WrappedShader^ shader = gcnew WrappedShader();
