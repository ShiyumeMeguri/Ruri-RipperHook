...
namespace HLSLccWrapper {
	...
	public ref class WrappedShader {
		public:
			String^ Text;
			int OK;
		static WrappedShader^ TranslateFromFile(String^ filepath, WrappedGLLang lang, WrappedGlExtensions^ extensions);
		static WrappedShader^ TranslateFromMem(array<unsigned char>^ data, WrappedGLLang lang, WrappedGlExtensions^ extensions);
	};
}
